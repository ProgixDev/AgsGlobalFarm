...
**GrowFarm** (package `com.progix.agsglobalfarmsarl`, Expo slug `ags-mobile`) is an Expo/React Native mobile application for agricultural job seekers and farm owners in Senegal. It provides job listings, training courses, and agricultural advice based on region/location.
