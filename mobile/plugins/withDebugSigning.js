 ...
 * changes the debug SHA-1 fingerprint and breaks anything registered against
 * it (an OAuth debug client, a Maps API key restriction), since those point
 * at the previous, now-gone key.
 *
